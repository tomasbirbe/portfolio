    ...
    <section className="page gap-14" id="projects">
      ...
      <article className="flex flex-col max-w-[600px] px-6 text-center gap-8">
        ...
        <span>
          ...
          haciendo click en el titulo del proyecto Todos los proyectos que encuentres estan en
          produccion y podes acceder a cada uno de ellos clickando en el titulo
        </span>
